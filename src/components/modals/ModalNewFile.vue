<template>
  <ModalLayout>
    ...
    <template v-slot:buttons>
      <button type="button" @click="createFile" class="vf-btn vf-btn-primary" style="margin-left:15px; background-color: #3e8e41; width:100px; height:30px; padding-top: 5px;">{{ t('Create') }}</button>
