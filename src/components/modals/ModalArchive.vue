<template>
  <ModalLayout>
    ...
    <template v-slot:buttons>
      <button type="button" @click="archive" class="vf-btn vf-btn-primary" style="margin-left:15px; background-color: #a0aec0; width:100px; height:30px; padding-top: 5px;">{{ t('Archive') }}</button>
