<template>
  <ModalLayout>
    ...
    <template v-slot:buttons>
      <button type="button" @click="remove" class="vf-btn vf-btn-danger" style="margin-left: 10px; background-color: #a0aec0; width: 100px; height: 30px; padding-top: 5px;">{{ t('Delete!') }}</button>
