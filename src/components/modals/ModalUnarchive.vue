<template>
  <ModalLayout>
    ...
    <template v-slot:buttons>
      <button type="button" @click="unarchive" class="vf-btn vf-btn-primary" style="margin-left: 10px; background-color: #a0aec0; width: 100px; height: 30px; padding-top: 5px;">{{ t('Unarchive') }}</button>
      <button type="button" @click="app.modal.close()" class="vf-btn vf-btn-secondary" style="padding-top: 5px;">{{ t('Cancel') }}</button>
    </template>
  </ModalLayout>
</template>
