<template>
  <ModalLayout>
    ...
    <template v-slot:buttons>
      <button type="button" @click="createFolder" class="vf-btn vf-btn-primary" style="margin-left:15px; background-color: #ca8a04; width:100px; height:30px; padding-top: 5px;">{{ t('Create') }}</button>
