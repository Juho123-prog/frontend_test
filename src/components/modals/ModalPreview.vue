  ...
  <ModalLayout>
    ...
    <template v-slot:buttons>
      ...
      <a
        ...
        style="margin-left:15px; background-color: #007bff; width:100px; height:30px; padding-top: 5px;"
      >{{ t('Download') }}</a>

      <button type="button" @click="app.modal.close()" class="vf-btn vf-btn-secondary" style="margin-top: 10px; margin-left: 10px;">{{ t('Close') }}</button>
    </template>
  </ModalLayout>
</template>
